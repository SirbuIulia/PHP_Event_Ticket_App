...
<?php
    ...
    if ($result = $mysqli->query("SELECT * FROM speakeri ORDER BY ID"))
    {
        if ($result->num_rows > 0)
        {
            ...
            echo "<tr><th>Nume</th><th>Prenume</th><th>Numar de telefon</th><th>Email</th><th>Domeniu</th><th>ID Eveniment</th><th></th><th></th></tr>";
    ...
    ?>
<p>
    <a href="Inserare.php" class='inserare-btn'> Adaugare speaker</a>
</body>
</html>